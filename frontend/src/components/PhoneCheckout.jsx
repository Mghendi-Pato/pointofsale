    ...
    <AnimatePresence>
      {showPhoneCheckout && (
        <motion.div
          ...
          className="absolute bottom-0 md:top-0 right-0 w-full  md:h-full z-50 md:w-[40%] lg:w-[30%] bg-neutral-100 flex flex-col items-center p-2">
                ...
                <div className="w-full h-full md:h-auto overflow-y-auto px-2 pb-10">
                  <form
                    ...
                    <TextField
                      ...
                      helperText={
                        formik.touched.nkPhone && formik.errors.nkPhone
                      }
                      sx={{
                        "& .MuiOutlinedInput-root": {
                          "& fieldset": {
